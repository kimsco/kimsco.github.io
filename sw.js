const CACHE = "mf-v21"; // 🔥 [실험] 부팅 스플래시 & apple-touch-startup-image에서 로고를 빼고 순수 검정만 남김(로고 모양이 있어야 iOS 전환 중 밝기 변화가 "겹쳐 보이는 유령상"처럼 도드라져 보였던 것으로 추정) — 캐시 이름을 다시 올려서 새로 받아오게 함
const ASSETS = [
  "/",
  "/index.html",
  "/manifest.json",
